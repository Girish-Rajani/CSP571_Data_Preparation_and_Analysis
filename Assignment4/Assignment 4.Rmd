...
#Convert lowercase
corpusVectorSource <- tm_map(corpusVectorSource, content_transformer(tolower))

#Remove stopwords
corpusVectorSource <- tm_map(corpusVectorSource, removeWords, stopwords("en"))
...
pred_svm_test = predict(fit_svm_train, train)
train_acc = mean(pred_svm_train == train_labels)
cat("The test accuracy of SVM is :", train_acc*100, "%")
